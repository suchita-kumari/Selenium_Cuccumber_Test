...
public class MiscMethods 
{
	...
	{
		return Arrays.asList("id","class","css","name","xpath","model","buttonText","repeater").contains(type);
	}

	/** Method to verify locator type
	 * @param type : String :Locator type (id, name, class, xpath, css,model,buttonText,repeater)
	 */
